...
const getProductsIfExist = () => {
    return axios.get('https://book-server-sable.vercel.app/products/getProductsIfExist');
};

const getCountUser = () => {
    return axios.get('https://book-server-sable.vercel.app/accounts/getCountUser');
};
const getTotalOrders = () => {
    return axios.get('https://book-server-sable.vercel.app/order/getTotalOrders');
}
const getTotalSales = () => {
    return axios.get('https://book-server-sable.vercel.app/order/getTotalSales');
}

const getPendingOrders = () => {
    return axios.get('https://book-server-sable.vercel.app/order/getPendingOrders');
}

const getRecentTransactions = () =>{
    return axios.get('https://book-server-sable.vercel.app/order/getRecentTransactions');
}
...
const getAccountbyName = (full_name) => {
    return axios.get(`https://book-server-sable.vercel.app/accounts/getusername/?full_name=${full_name}`);
}
